...
@section('content')
<div class="container-fluid px-0 px-md-4"> {{-- Padding disesuaikan untuk mobile --}}
    {{-- Welcome Banner --}}
    <div class="row mb-4">
        <div class="col-12">
            <div class="bg-white rounded-4 shadow-sm p-4" style="border: 1px solid rgba(12, 44, 90, 0.1);">
                <div class="d-flex align-items-center">
                    <div class="d-none d-md-flex justify-content-center align-items-center rounded-circle me-4" style="width: 80px; height: 80px; background-color: rgba(12, 44, 90, 0.1);">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Here's what's happening today on Indiegologi.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        ...
        {{-- [DIUBAH] Grid diubah agar lebih responsif --}}
    ...
    {{-- Page Visits and Chart Section --}}
    {{-- Page Visits and Chart Section --}}
<div class="row">
    {{-- Kolom Kiri: Daftar Kunjungan Halaman --}}
...
{{-- Baris Baru Khusus untuk Grafik --}}
<div class="row">
    <div class="col-12">
        <div class="bg-white rounded-3 shadow-sm p-4" style="border: 1px solid rgba(12, 44, 90, 0.1);">
            ...
            <div style="height: 400px;"> {{-- Beri tinggi eksplisit untuk canvas container --}}
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(12, 44, 90, 0.8)',
