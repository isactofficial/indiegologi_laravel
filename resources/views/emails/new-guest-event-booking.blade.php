                    ...
                    <tr>
                        <td align="center" style="padding: 25px; background-color: #1f3a5f; color: #ffffff;">
                            ...
                            <h2 style="margin: 5px 0 0 0; font-size: 18px; font-weight: 400; color: #a9c5ec;">
                                Notifikasi Booking Event Baru (Guest)
                            </h2>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td width="50%" class="stack-cell" style="padding-bottom: 8px;">
                                        ...
                                        <!-- Added word-wrap to prevent overflow by long Invoice ID -->
                                    </td>
                                    <td width="50%" class="stack-cell" style="padding-bottom: 8px;">
                                        <strong style="color: #333333;">Tanggal Pesan:</strong>
                                        {{ \Carbon\Carbon::parse($booking->event->created_at)->format('d M Y') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="stack-cell" style="padding-bottom: 8px;">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="stack-cell" style="padding-bottom: 8px;">
                                        ...
                                        <span
                                            style="font-weight: bold; color: #e57300;">{{ ucfirst($booking->booking_status) }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
