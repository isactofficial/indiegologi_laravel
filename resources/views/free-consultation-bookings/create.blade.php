                ...
                <div class="form-section mb-4 participant-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-text">
                                Total peserta termasuk data pemesan.
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        try {
            ...
            // Isi data tampilan
            const serviceName = bookingData.service_name.split(': ')[1];
            ...
            if (bookingData.session_type === 'Offline') {
        ...
        sessionTypeSelect.addEventListener('change', function() {
            ...
            bookingData.session_type = this.value;
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Validasi Sesi Offline
            if (sessionTypeSelect.value === 'Offline' && !offlineAddressTextarea.value.trim()) {
                submitBtn.disabled = false;
                submitBtn.innerHTML = originalText;
                return Swal.fire('Perhatian!', 'Harap isi alamat lengkap untuk sesi Offline.', 'info');
            }
            
            // Validasi Peserta Dinamis
            ...
            if (!isValidParticipants) {
                 submitBtn.disabled = false;
                 submitBtn.innerHTML = originalText;
                 return Swal.fire('Data Peserta Tidak Lengkap', 'Harap lengkapi nama dan nomor telepon untuk semua peserta yang Anda tambahkan.', 'error');
            }
            ...
            .then(data => {
                if (data.success) {
                    ...
                    let errorMessage = data.message || 'Terjadi kesalahan validasi.';
                    if (data.errors) {
            ...
            .catch(error => {
                ...
                Swal.fire('Error!', 'Terjadi kesalahan jaringan atau server saat booking.', 'error');
            })
            .finally(() => {
                submitBtn.disabled = false;
                submitBtn.innerHTML = originalText;
