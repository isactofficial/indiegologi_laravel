                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="items[{{ $loop->index }}][discount_amount]" class="form-control item-discount" value="{{ $item->discount_amount ?? 0 }}" min="0" onchange="calculateTotals()">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Total</label>
                                        <input type="text" class="form-control item-total" value="Rp {{ number_format(($item->quantity * $item->unit_price) - ($item->discount_amount ?? 0), 0, ',', '.') }}" readonly>
