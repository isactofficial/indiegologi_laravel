...
<style>
    ...
    .custom-select-dropdown {
        background-color: #f0f4f8; /* Latar belakang lebih netral */
        border-radius: 0.75rem;
        padding: 0.6rem 1.2rem;
        font-size: 0.9rem;
        font-weight: 600;
        color: var(--theme-primary); /* Warna teks primer baru */
        transition: all 0.3s ease-in-out;
        border: 1px solid rgba(12, 44, 90, 0.2); /* Border dengan warna primer baru */
    ...
    .custom-select-dropdown:focus {
        border-color: var(--theme-primary); /* Fokus pada warna primer baru */
        box-shadow: 0 0 0 0.25rem rgba(12, 44, 90, 0.25); /* Glow dengan warna primer baru */
        outline: none;
    }
    ...
    .alert-custom-success {
        background-color: rgba(12, 44, 90, 0.1); /* Light tint of new primary */
        color: var(--theme-primary); /* New primary color text */
                    ...
                    <tbody>
                        @forelse($articles as $article)
                            <tr style="border-bottom: 1px solid #f0f0f0;">
                                ...
                                <td class="py-3">
                                    @php
                                        // [TETAP] Logika status badge tidak diubah
...
<script>
    function confirmDelete(event, form) {
        ...
        Swal.fire({
            ...
            confirmButtonColor: "#cb2786", // Warna danger/hapus
