...
<head>
    ...
    <title>500 Internal Server Error - Terjadi Kesalahan</title>
...
<body>
    <div class="container-error">
        <h1>500</h1>
        <h2>Oops! Ada Masalah di Server Kami</h2>
        <p>Sepertinya terjadi kesalahan teknis di sistem kami. Ini bukan salah Anda, kami mohon maaf atas ketidaknyamanannya.</p>
        <p>Tim kami telah diberitahu dan sedang bekerja untuk memperbaikinya. Silakan coba lagi nanti.</p>
