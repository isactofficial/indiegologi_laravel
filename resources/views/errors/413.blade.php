...
<head>
    ...
    <title>413 Payload Too Large - Muatan Terlalu Besar</title>
...
<body>
    <div class="container-error">
        <h1>413</h1>
        <h2>Oops! Muatan Terlalu Besar</h2>
        <p>Permintaan Anda ditolak karena ukurannya terlalu besar. Ini biasanya terjadi jika Anda mencoba mengunggah file yang melebihi batas.</p>
        <p>Silakan coba lagi dengan file yang lebih kecil.</p>
        <a href="{{ url()->previous() }}" class="cta-button">Kembali & Coba Lagi</a>
