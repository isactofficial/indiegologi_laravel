...
<body>
    <div class="container-error">
        <h1>429</h1>
        <h2>Oops! Terlalu Banyak Permintaan</h2>
        <p>Anda telah mencoba mengakses halaman ini terlalu sering dalam waktu singkat. Sistem kami membatasi jumlah permintaan untuk menjaga stabilitas.</p>
        <p>Silakan tunggu beberapa saat sebelum mencoba kembali.</p>
