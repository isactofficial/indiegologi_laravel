...
<head>
    ...
    <title>419 Page Expired - Halaman Kadaluwarsa</title>
...
<body>
    <div class="container-error">
        <h1>419</h1>
        <h2>Oops! Halaman Telah Kadaluwarsa</h2>
        <p>Halaman ini tidak lagi valid, kemungkinan karena Anda terlalu lama tidak aktif. Ini adalah langkah keamanan untuk melindungi data Anda.</p>
        <p>Silakan segarkan halaman sebelumnya dan coba lagi.</p>
        <a href="{{ url()->previous() }}" class="cta-button">Kembali ke Halaman Sebelumnya</a>
