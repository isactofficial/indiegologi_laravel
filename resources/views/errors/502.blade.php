...
<head>
    ...
    <title>502 Bad Gateway - Gateway Buruk</title>
...
<body>
    <div class="container-error">
        <h1>502</h1>
        <h2>Oops! Gateway Buruk</h2>
        <p>Server kami menerima respons yang tidak valid dari server lain. Ini adalah masalah sementara pada infrastruktur kami.</p>
        <p>Kami sedang memperbaikinya. Silakan coba muat ulang halaman ini sebentar lagi.</p>
        <a href="{{ url()->current() }}" class="cta-button">Coba Muat Ulang</a>
