...
<head>
    ...
    <title>400 Bad Request - Permintaan Tidak Valid</title>
...
<body>
    <div class="container-error">
        <h1>400</h1>
        <h2>Oops! Permintaan Tidak Valid</h2>
        <p>Server tidak dapat memproses permintaan Anda karena formatnya salah atau rusak. Mohon pastikan permintaan Anda sudah benar.</p>
        <p>Jika Anda tidak yakin, coba kembali ke halaman utama.</p>
