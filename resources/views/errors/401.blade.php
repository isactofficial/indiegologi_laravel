...
<head>
    ...
    <title>401 Unauthorized - Autentikasi Diperlukan</title>
...
<body>
    <div class="container-error">
        <h1>401</h1>
        <h2>Oops! Autentikasi Diperlukan</h2>
        <p>Maaf, Anda harus masuk (login) terlebih dahulu untuk mengakses halaman ini. Sesi Anda mungkin telah berakhir atau Anda belum login.</p>
