        ...
        <div class="col-12">
            ...
            <div class="bg-white rounded-4 shadow-sm p-4" style="border-left: 8px solid #f4b704;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="fs-3 fw-bold mb-1" style="color: #f4b704;">Update Layanan</h2>
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.consultation-services.update', $consultationService->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    @php
                        // -- LOGIKA DATA ADD-ON --
                        // Ambil semua data add-on (dari validasi error ATAU database)
                        $addOns = old('add_ons', $consultationService->add_ons ?? []);
                        $hasOldOrSavedAddOns = !empty($addOns);
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div id="service-add-on-container" class="vstack gap-3">
                            ...
                            @if($hasOldOrSavedAddOns)
                                {{-- 1A. Render data tersimpan/lama (HANYA TIPE 'existing' ATAU 'custom' NON-PAINTING) --}}
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div id="painting-add-on-container" class="vstack gap-3">
                            ...
                            @if($hasOldOrSavedAddOns)
                                {{-- 2A. Render data tersimpan/lama (HANYA TIPE 'custom' DENGAN JUDUL 'Painting:') --}}
                                @foreach($addOns as $index => $addOn)
                                    @php
                                        $addOn = (array) $addOn;
                                        $isCustom = $addOn['type'] == 'custom';
