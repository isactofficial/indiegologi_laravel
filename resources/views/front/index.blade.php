...
<section class="container py-5 my-5">
    <div class="text-center" data-aos="fade-up">
        ...
        <p style="font-size:1.15rem; color:#6c757d; font-family: 'Playfair Display', serif;">Kumpulan cerita tulus dari mereka yang telah berproses dengan indiegologi untuk menemukan kedamaian, kebahagiaan dan cinta diri</p>
    </div>
                    ...
                    <div class="testimonial-flipper">
                        ...
                        <div class="testimonial-card-front">
                            <div class="testimonial-square-card">
                                <img src="{{ $testimonial->image_url }}" alt="Foto {{ $testimonial->name }}" class="testimonial-bg-img">
                                <div class="testimonial-content">
                                    <p class="testimonial-quote">"{{ $testimonial->quote }}"</p>
                                    <div class="testimonial-author">
                                        <h5 class="testimonial-name">{{ $testimonial->name }}</h5>
                                        <p class="testimonial-details">{{ $testimonial->age }} Tahun, {{ $testimonial->occupation }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
