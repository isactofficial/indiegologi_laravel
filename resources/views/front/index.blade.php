...
@push('styles')
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            ...
            #sketch-gallery-wrapper .gallery-carousel {
                height: 320px;
                /* Dikurangi dari 480px untuk membuat lebih kotak */
                padding-top: 20px;
            }

            #sketch-gallery-wrapper .gallery-image-item {
                height: 320px;
                /* Sesuaikan dengan carousel height */
                width: 70%;
                /* Diperlebar dari 60% */
                left: 15%;
                /* Disesuaikan untuk centering */
                padding: 8px;
                /* Dikurangi padding */
            }
            ...
            #sketch-gallery-wrapper .gallery-image-item img {
                ...
                /* Disesuaikan dengan padding yang lebih kecil */
            }
        ...
        @media (max-width: 575.98px) {
            ...
            #sketch-gallery-wrapper .gallery-image-item {
                height: 280px;
                width: 75%;
                /* Sedikit lebih lebar pada layar sangat kecil */
                left: 12.5%;
                /* Disesuaikan untuk centering */
            }
        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
            < class="carousel-inner">
                ...
                <div class="carousel-item"
                    style="background-image: url('{{ asset('assets/carousel/kobu-agency-7okkFhxrxNw-unsplash1.jpg') }}');">
                    <div class="overlay"></div>
                    <div class="carousel-caption">
                        <div class="container">
