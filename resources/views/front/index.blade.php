                ...
                <div class="carousel-item active" style="background-image: url('{{ asset('assets/carousel/christina-wocintechchat-com-eF7HN40WbAQ-unsplash.jpg') }}');">
                    ...
                    <div class="carousel-caption d-flex flex-column justify-content-center h-100">
                        <div class="container text-start text-white">
                            ...
                            <p class="lead mb-2 text-white-50">Jalani proses penyembuhan diri yang **penuh perhatian** dan **nyaman** bersama kami, untuk menemukan kedamaian batin yang mendalam.</p>
                            <br>
                            <br>
                ...
                <div class="carousel-item" style="background-image: url('{{ asset('assets/carousel/kobu-agency-7okkFhxrxNw-unsplash.jpg') }}');">
                    ...
                    <div class="carousel-caption d-flex flex-column justify-content-center h-100">
                        <div class="container text-start text-white">
                            ...
                            <p class="lead mb-2 text-white-50">Ekspresikan perjalanan emosional Anda dengan **elegan** dan **personal**, mendokumentasikan setiap langkah menuju **cinta diri**.</p>
                            <br>
                            <br>
                ...
                <div class="carousel-item" style="background-image: url('{{ asset('assets/carousel/maranda-vandergriff-7aakZdIl4vg-unsplash.jpg') }}');">
                    ...
                    <div class="carousel-caption d-flex flex-column justify-content-center h-100">
                        <div class="container text-start text-white">
                            ...
                            <p class="lead mb-2 text-white-50">Panduan **penuh kasih** untuk membantu Anda menemukan keindahan dan **kekuatan** di setiap tahap kehidupan.</p>
                            <br>
                            <br>
                    ...
                    <div class="swiper-slide">
                        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center bg-white rounded-4 shadow-sm border border-light featured-popular-card">
                            ...
                            <div class="flex-grow-1 text-lg-start text-center featured-popular-content">
                                <h3 class="fw-bold mb-2 featured-popular-title" style="color: #0C2C5A;">{{ Str::limit($article->title, 60) }}</h3>

                                {{-- Menampilkan deskripsi singkat dari kolom 'description' --}}
                                <p class="mb-3 featured-popular-desc" style="color:#4a5a6a; font-size:1.15rem;">{{ Str::words(strip_tags($article->description), 15, '...') }}</p>

                                <p class="text-secondary mb-2 featured-popular-date">{{ optional($article->created_at)->format('d F Y') }}</p>
                                <a href="{{ route('front.articles.show', $article->slug) }}" class="btn btn-link text-decoration-none fw-semibold p-0 featured-popular-link" style="color: #0C2C5A;">Baca Lebih Lanjut <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="swiper-slide">
                        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center bg-white rounded-4 shadow-sm border border-light featured-popular-card">
                            <div class="flex-shrink-0 mb-4 mb-lg-0 me-lg-5 featured-popular-img-wrap">
                                <img src="https://via.placeholder.com/600x400.png?text=Artikel+Pilihan" alt="Placeholder" class="img-fluid rounded-3 featured-popular-img">
                            </div>
                            <div class="flex-grow-1 text-lg-start text-center featured-popular-content">
                                <h3 class="fw-bold mb-2 featured-popular-title" style="color: #0C2C5A;">Judul Artikel Pilihan Kami</h3>

                                {{-- Deskripsi placeholder --}}
                                <p class="mb-3 featured-popular-desc" style="color:#4a5a6a; font-size:1.15rem;">Deskripsi singkat yang menginspirasi dan tulus untuk Anda.</p>

                                <p class="text-secondary mb-2 featured-popular-date">Tanggal</p>
                                <a href="#" class="btn btn-link text-decoration-none fw-semibold p-0 featured-popular-link" style="color: #0C2C5A;">Baca Lebih Lanjut <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                @endforelse
...
{{-- 3. Artikel Terbaru (Slider) --}}
    <section class="container py-5 my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('front.articles') }}" class="btn btn-link text-decoration-none fw-semibold p-0" style="color: #0C2C5A;">Lihat Semua Artikel <i class="bi bi-arrow-right"></i></a>
        </div>
                    ...
                    <div class="swiper-slide pb-3">
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text mb-3" style="color:#4a5a6a;">{{ Str::words(strip_tags($article->description), 15, '...') }}</p>
                                <a href="{{ route('front.articles.show', $article->slug) }}" class="mt-auto text-decoration-none fw-semibold" style="color: #0C2C5A;">Baca Lebih Lanjut</a>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="swiper-slide">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="article-img-container">
                                <img src="https://via.placeholder.com/600x300.png?text=Artikel+Terbaru" alt="Placeholder" class="card-img-top">
                            </div>
                            <div class="card-body">
                                <h5 class="fw-bold" style="color: #0C2C5A;">Judul Artikel Terbaru</h5>
                                <p class="text-secondary small mb-2">Tanggal</p>
                                <p class="card-text mb-3" style="color:#4a5a6a;">Deskripsi singkat tentang artikel terbaru ini. Konten yang elegan dan menawan untuk Anda.</p>
                                <a href="#" class="mt-auto text-decoration-none fw-semibold" style="color: #0C2C5A;">Baca Lebih Lanjut</a>
                            </div>
                        </div>
                    </div>
                @endforelse
...
{{-- 4. Artikel Populer (Slider 3 Kolom) --}}
    <section class="container py-5 my-5">
         <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('front.articles') }}" class="btn btn-link text-decoration-none fw-semibold p-0" style="color: #0C2C5A;">Jelajahi Semua <i class="bi bi-arrow-right"></i></a>
        </div>
        <div class="swiper latest-articles-swiper">
            <div class="swiper-wrapper">
                @forelse ($popular_articles as $article)
                ...
                @empty
                    <div class="swiper-slide">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="article-img-container" style="padding-top: 56.25%;">
                                <img src="https://via.placeholder.com/600x338.png?text=Artikel+Populer" alt="Placeholder" class="card-img-top">
                            </div>
                            <div class="card-body d-flex flex-column">
                                <h5 class="fw-bold" style="color: #0C2C5A;">Judul Artikel Populer</h5>
                                <p class="text-secondary small mb-2">Tanggal</p>
                                <p class="card-text mb-3" style="color:#4a5a6a;">Deskripsi singkat tentang artikel terpopuler ini, sebuah inspirasi yang tulus untuk Anda.</p>
                                <a href="#" class="mt-auto text-decoration-none fw-semibold" style="color: #0C2C5A;">Baca Lebih Lanjut</a>
                            </div>
                        </div>
                    </div>
...
.card .article-img-container {
    ...
    position: relative;
    overflow: hidden;
    background-color: #f0f0f0; /* Opsional: Warna latar belakang jika gambar gagal dimuat */
}
