...
@section('content')
<section class="py-5 pt-lg-0 mt-5"> <div class="container">
            ...
            <div class="col-lg-5">
                <div class="p-4 p-lg-4 rounded-4 mb-4" style="background-color: #ffffff; box-shadow: 0 10px 30px rgba(12, 44, 90, 0.08);">
                    ...
                    <div class="d-flex mb-4 align-items-start">
                        <div class="me-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-building" viewBox="0 0 16 16">
                    ...
                    <div class="d-flex mb-4 align-items-start">
                        <div class="me-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-building-fill" viewBox="0 0 16 16">
                    ...
                    <div class="d-flex align-items-start">
                        <div class="me-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                </svg>
                            </div>
                        </div>
                        <div>
                            <h6 class="fw-bold mb-1" style="color: #0C2C5A;">Phone</h6>
                            <p class="mb-1">
                ...
                <div class="p-4 p-lg-4 rounded-4" style="background-color: #ffffff; box-shadow: 0 10px 30px rgba(12, 44, 90, 0.08);">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <a href="https://www.instagram.com/indiegologi/" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <a href="https://www.linkedin.com/company/indiegologi/" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-linkedin" viewBox="0 0 16 16">
                        ...
                        <a href="mailto:indiegologiofficial@gmail.com" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0C2C5A" class="bi bi-envelope" viewBox="0 0 16 16">
