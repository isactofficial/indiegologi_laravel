            ...
            <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200">
                <div class="p-4 p-lg-4 rounded-4" style="background-color: #ffffff; box-shadow: 0 10px 30px rgba(12, 44, 90, 0.08);">
                    ...
                    <div class="d-flex flex-column gap-3">
                        {{-- Sosial media links --}}
                        <a href="https://www.instagram.com/indiegologi/" target="_blank" class="d-flex align-items-center text-decoration-none p-3 rounded-3 contact-link">
                            <div class="me-3">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0" style="color: #0C2C5A;">Instagram</h6>
                                <p class="mb-0 text-muted small">indiegologi_official</p>
                            </div>
                        </a>
                        <a href="https://www.linkedin.com/company/indiegologi/" target="_blank" class="d-flex align-items-center text-decoration-none p-3 rounded-3 contact-link">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background-color: #D6E4FF; width: 50px; height: 50px;">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0" style="color: #0C2C5A;">LinkedIn</h6>
