                                        ...
                                        <div class="accordion-button collapsed rounded-4" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-free-consultation">
                                            <div class="d-none d-md-flex justify-content-between align-items-center w-100">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://placehold.co/100x100/D4AF37/ffffff?text=Gratis" alt="Konsultasi Gratis" class="rounded-3 me-3" style="width:100px;height:100px;object-fit:cover">
                                                    <div>
                                                        <h5 class="fw-bold mb-1">Konsultasi Gratis</h5>
                                                        <p class="text-muted mb-0">Coba sesi 1 jam pertama Anda tanpa biaya.</p>
                                                    </div>
                                                </div>
                                                <button class="btn-details-toggle" type="button">Baca Selengkapnya</button>
                                            </div>
                                            <div class="d-flex d-md-none service-header-mobile">
                                                <img src="https://placehold.co/400x200/D4AF37/ffffff?text=Gratis" alt="Konsultasi Gratis" class="service-thumbnail-mobile">
                                                <div class="service-header-mobile-top">
                                                    <div>
                                                        <h5 class="fw-bold mb-1">Konsultasi Gratis</h5>
                                                        <p class="text-muted mb-0">Coba sesi 1 jam pertama.</p>
                                                    </div>
                                            ...
                                            <div class="service-block" data-service-id="free-consultation">
                                                <div class="stagger-item">
                                                    <div class="row mb-4">
                                                        <div class="col-12">
                                                            ...
                                                            <p>Sesi konsultasi gratis ini dirancang untuk memberikan Anda gambaran tentang bagaimana kami dapat membantu. Selama 1 jam, Anda akan berbicara dengan konselor kami untuk membahas tujuan Anda dan menentukan langkah selanjutnya.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-section mb-4">
                                                        <div class="row">
                                                            <div class="col-12 mb-3">
                                                                <h6 class="fw-bold">Pilih Jadwal Konsultasi:</h6>
                                                            ...
                                                            <div class="col-lg-4 col-md-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control hours-input" value="1" readonly>
                                                                    <small class="text-muted">Sesi gratis berdurasi 1 jam.</small>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-section contact-options mb-4">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input" type="radio" name="contact_preference-free-consultation" value="chat_and_call" checked>
                                                                <label class="form-check-label">Telepon & WhatsApp</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="contact_preference-free-consultation" value="chat_only">
                                                ...
                                                <div class="stagger-item">
                                                    <div class="row justify-content-between align-items-start mb-3">
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="button" class="btn btn-primary px-4 py-2 select-service-btn" data-service-id="free-consultation" disabled>
                                                                Booking Sesi Gratis
                                                            </button>
                                                        </div>
                                                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateCartCount() { 
                    // Update cart count logic here if needed
                }

                // Toggle offline address field based on session type
                ...
                $('.accordion-body').on('input change', '.service-date-picker, .booked_time-input, .hours-input, .session-type-select', function() {
                    ...
                    let hoursBooked = 1; // Default for free consultation
