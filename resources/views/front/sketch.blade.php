...
<div class="sketch-telling-section">
    <div class="container">
        ...
        <p class="section-description">Lihatlah kisah-kisah yang kami visualisasikan untuk inspirasi dan pemahaman yang lebih dalam tentang berbagai perjalanan hidup</p>
        ...
        <div class="cards-grid">
            ...
            <div class="card">
                <a href="{{ route('front.sketches.detail', ['sketch' => $sketch->slug]) }}">
                    <img src="{{ asset('storage/' . $sketch->thumbnail) }}" class="card-image" alt="{{ $sketch->title }}">
                </a>
