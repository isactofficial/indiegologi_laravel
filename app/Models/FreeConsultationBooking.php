...
class FreeConsultationBooking extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(FreeConsultationParticipant::class, 'consultation_booking_id');
    }

    // App/Models/ConsultationBooking.php

    public function schedule()
    {
        return $this->belongsTo(FreeConsultationSchedule::class, 'schedule_id');
    }
